...
from app.plugins.windows_security.parse import iter_windows_security_events
from app.plugins.windows_security.map_to_ocsf import map_windows_security_authentication_to_ocsf
